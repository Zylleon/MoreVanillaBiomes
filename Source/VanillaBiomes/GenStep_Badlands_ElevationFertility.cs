...
{
    public class GenStep_Badlands_ElevationFertility : GenStep
    {
        ...
        public override void Generate(Map map, GenStepParams parms)
        {
            ...
            ModuleBase moduleBase = new Perlin(0.04, 2.5, 0.5, 6, Rand.Range(0, 2147483647), QualityMode.High);
            ...
            {
                case Hilliness.Flat:
                    hillFactor = MapGenTuning.ElevationFactorFlat;
                    break;
                case Hilliness.SmallHills:
                    hillFactor = MapGenTuning.ElevationFactorSmallHills;
                    break;
                case Hilliness.LargeHills:
                    hillFactor = MapGenTuning.ElevationFactorLargeHills;
                    break;
                case Hilliness.Mountainous:
                    hillFactor = MapGenTuning.ElevationFactorMountains;
                    break;
                case Hilliness.Impassable:
                    hillFactor = MapGenTuning.ElevationFactorImpassableMountains;
                    break;
            }
            moduleBase = new Multiply(moduleBase, new Const((double)hillFactor));
